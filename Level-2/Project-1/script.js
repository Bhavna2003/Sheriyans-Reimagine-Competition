var arr = [
    {name: "Peacock", image: "https://images.unsplash.com/photo-1559048958-4d1a3dc247d1?q=80&w=1950&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"},
    {name: "Food", image: "https://images.unsplash.com/photo-1708368954671-f383a1887157?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8Nzl8fHxlbnwwfHx8fHw%3D"},
    {name: "Paint Brush", image: "https://images.unsplash.com/photo-1708570735809-8a3bbc0ce0de?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mzh8fHxlbnwwfHx8fHw%3D"},
...
function showCards(){
    ...
    arr.forEach(function(object){
        ...
        <img class="cursor-pointer" src="${object.image}" alt="image">
